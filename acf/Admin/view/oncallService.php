            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary" style="margin-bottom:20px;">
                  ...
                  <h4 class="card-title" style="text-transform:uppercase;"><b>ON CALL SERVICE APPLY</b></h4>
                  <p class="card-category"> RECENT ON CALL SERVICE APPLY</p>
                    ...
                    <table class="table table-bordered" id="myTable">
                      ...
                      <tbody>
                        <?php
                                  ...
                                  $where="";
                                  $data=$objFun->selectData('oncall_service',$where);
                        ...
                        <tr>
                          ...
                          <td><?=$value['service_for']?></td>
                          <td><?=$value['we_need_help _because']?></td>
                          <td><?=$value['we_need_help']?></td>
                          <td><?=$value['we_need_this_help']?></td>
                          <td><?=$value['Assessment']?></td>
                          <td>
                            
                            <a href="../controller/deleteData.php?id=<?=base64_encode($value['id'])?>&type=<?=base64_encode('oncallservice')?>">
