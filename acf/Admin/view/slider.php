    ...
    margin:0px;
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary" style="margin-bottom:20px;">
                  ...
                  <h4 class="card-title" style="text-transform:uppercase;"><b>Slider</b></h4>
                  <p class="card-category"> Home Page Slider</p>
                    ...
                    <table class="table table-bordered" id="myTable">
                      ...
                      <tbody>
                        <?php
                                  ...
                                  $where="";
                                  $data=$objFun->selectData('slider',$where);
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <a href="../controller/deleteData.php?id=<?=base64_encode($value['id'])?>&type=<?=base64_encode('slider')?>">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="../controller/checkData.php?ptype=<?=base64_encode('slider')?>" method="POST" name="slider" onsubmit=" return checkData()" enctype="multipart/form-data">
...
<!-- ===============================================================Validation============================================================ -->
      <script type="text/javascript">
        function checkData()
        {
             ...
             var image= document.slider.image.value;

             if(image==''){

                document.getElementById('imgMessage').innerHTML='* Please Upload Slider Image';
