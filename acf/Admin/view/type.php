    ...
    margin:0px;
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary" style="margin-bottom:20px;">
                  ...
                  <h4 class="card-title" style="text-transform:uppercase;"><b>PROJECTS</b></h4>
                  <p class="card-category"> RECENT PROJEDCTS</p>
                  ...
                  <div class="">
                    <table class="table table-bordered" id="myTable">
                      <thead class=" text-primary bg-info">
                        <th class="text-center" style=" font-size:25px; width:20%;">
                          #
                        </th>
                      ...
                      <tbody>
                        <?php
                                  ...
                                  $where="";
                                  $data=$objFun->selectData('gallary',$where);
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <a href="../controller/deleteData.php?id=<?=base64_encode($value['id'])?>&type=<?=base64_encode('gallary')?>">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="../controller/checkData.php?ptype=<?=base64_encode('gallary')?>" method="POST" name="categorytype" onsubmit=" return checkData()" enctype="multipart/form-data">
