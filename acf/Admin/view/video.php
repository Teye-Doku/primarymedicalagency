    ...
    margin:0px;
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary" style="margin-bottom:20px;">
                  ...
                  <h4 class="card-title" style="text-transform:uppercase;"><b>VIDEO</b></h4>
                  <p class="card-category"> RECENT VIDEO</p>
                    ...
                    <table class="table table-bordered" id="myTable">
                      ...
                      <tbody>
                        <?php
                                  ...
                                  $where="";
                                  $data=$objFun->selectData('video',$where);
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <a href="../controller/deleteData.php?id=<?=base64_encode($value['id'])?>&type=<?=base64_encode('video')?>">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="../controller/checkData.php?ptype=<?=base64_encode('video')?>" method="POST" name="categorytype" onsubmit=" return checkData()" enctype="multipart/form-data">
